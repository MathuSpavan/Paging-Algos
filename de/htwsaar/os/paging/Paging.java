...
public class Paging {
  ...
  public static void main(String[] args) {
    ...
    ReferenceStringReader referenceStringReader = new ReferenceStringReader(
      args[1]
    );
   ...
   */
  private static void processReferenceString(
    Tiles tiles,
    ReferenceStringReader referenceStringReader,
    ...
    while (referenceStringReader.hasNextReference()) {
      ...
      if ((tileAccessed = tiles.locate(pageNr)) != null) {
        ...
        if ((tileAccessed = tiles.getFreeTile()) != null) {
          ...
          tileAccessed = pagingAlgorithm.selectTileToReplace(tiles, pageNr,
              referenceStringReader.getListIteratorPastCurrent()
            );
    ...
    System.out.println("Number of page faults: " + nrOfPageFaults + " king!");
  }

  @SuppressWarnings("deprecation")
  private static PagingAlgorithm instantiatePagingAlgorithm(
  ...
  private static void usage() {
    ...
    System.out.println(
      "Paging <nrOfTiles> <referenceStringFile> <algorithmClass>"
    );
    System.exit(1);
  }
}
